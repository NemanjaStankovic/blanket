...
gulp.task("build", gulp.series('clean', 'copyLibs', 'compileBootstrap', 'compileScss', 'compileIcon', 'copyAssets', 'copyImages', 'copyFonts', 'compileJs'));

gulp.task("build-css", gulp.series('compileScss'));

gulp.task("build-img", gulp.series('copyImages'));
